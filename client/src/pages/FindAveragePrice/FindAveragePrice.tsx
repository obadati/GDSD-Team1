...
const Findaveragepricepage: React.FC<PropsFromRedux> = ({ properties }) => {
  ...
  return (
    ...
    <h1 style={{textAlign:'center',marginTop:'250px'}}>Find Average Price</h1>
  );
};
...
export default connector(Findaveragepricepage);
